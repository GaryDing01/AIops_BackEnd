...
//        System.out.println("workflowExec.getInputId(): " + workflowExec.getInputId());
        List<?> inputDataAll = workflowExecService.getInOutData(workflowExec.getInputTypeId(), workflowExec.getInputId(), 1);
        // 2.2 生成样例
...
//        System.out.println("inputSample: " + report.getInputData()); // 有乱码
        ...
        List<?> outputDataAll = workflowExecService.getInOutData(workflowExec.getOutputTypeId(), workflowExec.getOutputId(), 1);
        // 2.2 生成样例
