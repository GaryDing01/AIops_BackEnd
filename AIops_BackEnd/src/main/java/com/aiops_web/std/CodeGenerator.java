...
// import com.baomidou.mybatisplus.generator.config.po.TabzleFill;
...
//         dsc.setUrl("jdbc:mysql://localhost:3306/aiops_db?useUnicode=true&&characterEncoding=UTF-8");
//         dsc.setDriverName("com.mysql.cj.jdbc.Driver");
//         dsc.setUsername("AIops_Admin");//账号
//         dsc.setPassword("AIops_Admin");//密码
//         dsc.setDbType(DbType.MYSQL);
//         mpg.setDataSource(dsc);
//         //3、包的配置  生成的代码存放在项目的位置
//         PackageConfig pc = new PackageConfig();
//         //  pc.setModuleName("jiaxiao");//模块名称
//         pc.setParent("com.aiops_web.reverse");
//         pc.setEntity("entity");
//         pc.setMapper("dao");
